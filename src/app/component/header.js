...
const Header = () => {
  return (
    <>
      <div className="relative bg-gradient-to-l from-[#ffedc5] rounded-3xl my-5 mx-3 lg:mx-10 px-2 lg:px-10 py-5 md:py-10 ">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-5/12 order-last lg:order-first">
              <div className="hero-content">
                ...
                <ul className="flex flex-wrap items-center">
                  ...
                  <li>
                    <a
                      href="/features/gita"
                      className="inline-flex items-center justify-center px-5 py-3 text-center text-base text-[#fc9541] font-bold hover:underline"
                    >
                      Get Gita Verses
                      <svg
                        viewBox="0 0 24 24"
